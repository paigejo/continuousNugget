# function for making fancy colored table of simulation study results. Same 
# as makeFancyTable except tables labels are made more compact to reduce 
# whitespace.
# Refer to 
...
# function for making fancy colored table of simulation study results. 
# Refer to 
# https://cran.r-project.org/web/packages/kableExtra/vignettes/awesome_table_in_pdf.pdf
# for information about kableExtra
# valRanges: matrix with 2 rows and ncols length equal to the number of scoring rules with 
